    ...
    class SongPanelListenr extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            try {
                ...
                SliderListener sliderListener=new SliderListener(myMusicBox.getSlider(),myMusicBox,songPanel.getSong());
                myMusicBox.getSlider().addMouseListener(sliderListener);
                musicBox.getNextb().addActionListener(new NextClickListener(myMusicBox,SongPanels.this));
